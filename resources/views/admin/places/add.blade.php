...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <form method="POST" action="/admin/places/newPlace" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal form-label-left">
        {{csrf_field()}}
        ...
        {{--<div class="form-group">--}}
          ...
          {{--</label>--}}
          {{--<div class="col-md-6 col-sm-6 col-xs-12">--}}
            {{--<input id="name_urd" type="text" value="{{old('name_urd')}}" class="form-control col-md-7 col-xs-12 " name="name_urd" required="">--}}
          {{--</div>--}}
        {{--</div>--}}
