...
@section('content')
    ...
    <section class="topProfile">
        ...
        {{--onerror="this.src='{{asset('assets/client/images/banner.jpg')}}'"--}}
                            ...
                            <ul class="menu">
                                <li>
                                    ...
                                    <div class="li-text float-left">
                                        <p class="number-text">{{($videos->total())}}</p>
                                        <span>Videos</span>
                                    </div>
                                </li>
                            </ul>
    ...
    <div class="row">
                            ...
                            <div class="widgetContent">
                                <ul class="profile-overview">
                                 <li class="clearfix" id="likedVideosBan">
                                        <a href="javascript:;" class="active" id="likedVidMan">
                                            <i class="fa fa-video-camera"></i>Videos
                                            <span class="float-right">{{$videos->total()}}</span>
                                        </a>
                                </li>
                                @if(isset($data->album) && count($data->album) > 0)
                                    <li class="clearfix" id="albumsBan">
                                        <a class="" href="javascript:;" id="albumMan">
                                            <i class="fa fa-users"></i>Albums
                                            <span class="float-right">{{count($data->album)}}</span>
                                        </a>
                                    </li>
                                @endif
                                    <li class="clearfix" id="BioBan">
                                        <a class="" href="javascript:;" id="BioMan">
        ...
        <div  id="likedVidSec"  class="large-8 columns">
                                                ...
                                                <div class="post thumb-border">
                                                    <div class="post-thumb">
                                                        ...
                                                        <div class="video-stats clearfix">
                                                            ...
                                                            {{--<span>{{$val->seriesDetail->getMSDuration()}}</span>--}}
                                                            {{--</div>--}}
                                                        </div>
                                                    </div>
                                                    <div class="post-des">
        ...
        <div style="display: none"  id="BioSec" class="large-8 columns profile-inner">
        ...
        <div style="display: none"  id="abtMeSec" class="large-8 columns profile-inner">
            <section class="content content-with-sidebar">
                <!-- newest video -->
                <div class="main-heading">
                    <div class="row secBg padding-14">
                                            ...
                                            <input type="hidden" id="linkMe_{{$val->id}}" value="{{str_replace('#', '_', str_replace(' ', '-', str_replace('-', '*', $val->link)))}}">
                                                ...
                                                <div class="post thumb-border">
                                                    <div class="post-thumb">
                                                        ...
                                                        <a href="/album/{{str_replace('#', '_', str_replace(' ', '-', $val->name))}}" class="hover-posts"  >
                                                    ...
                                                    <div class="post-des">
                                                        <h6><a href="/album/{{str_replace('#', '_', str_replace(' ', '-', $val->name))}}">{{strlen($val->name) > 22 ? substr($val->name,0,22)."..." : $val->name}}</a></h6>
                                                        <div class="post-stats clearfix">
                                                            <p class="pull-left">
                                                                <i class="fa fa-user"></i>
                                                        ...
                                                        <div class="post-button">
                                                            <a href="/album/{{str_replace('#', '_', str_replace(' ', '-', $val->name))}}"><i class="fa fa-play-circle"></i>watch video</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
@section('js')
    <script>
			...
			$('#albumsBan').on('click', function () {
				$('#abtMeSec').show();
				$('#albumMan').addClass('active')
				$('#likedVidSec').hide();
				$('#likedVidMan').removeClass('active')

				$('#BioMan').removeClass('active');
				$('#BioSec').hide()
			});

			$('#BioMan').on('click', function () {
				$('#abtMeSec').hide();
				$('#albumMan').removeClass('active');
				$('#likedVidSec').hide();
				$('#likedVidMan').removeClass('active');

				$('#BioMan').addClass('active');
				$('#BioSec').show()
			});
    </script>
@endsection