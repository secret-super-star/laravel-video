                        ...
                        <div class="row secBg padding-14 removeBorderBottom">
                            <div class="medium-8 small-12 columns">
                                <div class="head-title">
                                    ...
                                    <h4>{{isset($cityName) ? $cityName : 'All Groups'}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="item large-4 medium-6 columns  {{$loop->last ? 'end' : ''}}  grid-default">
                                                ...
                                                <div class="post-des">
                                                    <h6><a href="javascript:;"
                                                           onclick="redirectMeForGroup('{{$val->id}}')">{{strlen($val->name) > 22 ? substr($val->name,0,22)."..." : $val->name}}</a>
                                                    </h6>
                                                        ...
                                                        <p class="pull-left">
                                                            ...
                                                            <span>
                                                                <a href="javascript:;">
                                                                    @php
                                                                        try {
                                                                            $place = strlen($val->places->name) > 18 ? substr($val->name,0,18)."..." : $val->places->name;
                                                                    ...
                                                                    <span onclick="window.location = '/city/{{str_replace('#', '_', str_replace(' ', '-', isset($val->places->name) ? $val->places->name : ''))}}'">{{strlen($place) > 10 ? substr($place,0,10)."..." : $place}}</span>
                                                                </a>
                                                            </span>
                                                        </p>
